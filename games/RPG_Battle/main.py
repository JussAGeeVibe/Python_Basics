...
curaga = Spell("Curaga", 60, 2000, "white")
...
player2 = Person("Sky  :", 4160, 188, 311, 34, player_spells, player_items)
player3 = Person("Jussa:", 3889, 174, 288, 34, player_spells, player_items)


enemy1 = Person("Flizz:", 1250, 130, 560, 325, enemy_spells, [])
enemy2 = Person("Draco:", 11200, 701, 525, 25, enemy_spells, [])
enemy3 = Person("Flazz:", 1250, 130, 560, 325, enemy_spells, [])
    ...
    for enemy in enemies:
        ...
        if enemy_choice == 0:
            ...
            if spell.type == "white":
                ...
                print(bcolors.FAIL + enemy.name.replace(" ","") + "'s " + spell.name + " deals", str(magic_dmg), "points of damage to " +
